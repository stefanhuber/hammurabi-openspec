...
- **THEN** 50 bushels of grain SHALL be deducted from the stock (100 × 0.5)
...
- **THEN** the player SHALL NOT be able to plant more than 1000 acres (100 × 10)

#### Scenario: Workforce constraint with small population
- **WHEN** the population is 50 people
- **THEN** the player SHALL NOT be able to plant more than 500 acres (50 × 10)
